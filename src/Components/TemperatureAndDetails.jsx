    ...
    return (
        <div>
            ...
            <div className='flex flex-row items-center justify-center space-x-2 text-white text-sm py-3'>
                ...
                <UilSun />
                <p className='font-light'>Rise:<span className='font-medium ml-1 '> 06:45 a.m.</span></p>
                <p className=' font-light'> | </p>

                <UilSunset />
                <p className='font-light'>Set:<span className='font-medium ml-1 '> 07:15 p.m.</span></p>
                <p className=' font-light'> | </p>
